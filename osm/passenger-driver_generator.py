...
def get_random_parameters():
    ...
    rand_pass_no = random.randint(3,30)
    # print('\nNumber of passengers: %d' % rand_pass_no)
    rand_dri_no = random.randint(1,10)
    ...
    min_pass_radius = math.floor(rand_pass_no/(max_passengers*3) * 3000)
    min_dri_radius = math.floor(rand_dri_no/(max_drivers*3) * 3000)
